...
//-----------------------------------------------------------------------------------//
static Ref_t create_DCH_vessel(Detector& description, xml_h e, [[maybe_unused]] SensitiveDetector sens)
...
//-----------------------------------------------------------------------------------//
static Ref_t create_DCH(Detector& description, xml_h e, SensitiveDetector sens)
{
  int i;
...
//@}
// clang-format off
DECLARE_DETELEMENT(D2EIC_DCH, create_DCH)
DECLARE_DETELEMENT(D2EIC_DCH_vessel, create_DCH_vessel)
