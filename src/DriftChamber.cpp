...
namespace DCH_v2 {
  ...
  static dd4hep::Ref_t create_DCH(dd4hep::Detector &desc, dd4hep::xml::Handle_t handle, dd4hep::SensitiveDetector sens)
  {
	...
	- safety_z_interspace;
      ...
      fwire2_v.setVisAttributes(desc.visAttributes( Form("dch_vis_cell_%d",(int) ilayer%2 )));
	...
	- safety_z_interspace;
      ...
      fwire1_v.setVisAttributes(desc.visAttributes( Form("dch_vis_cell_%d",(int) ilayer%2 )));
	...
	- safety_z_interspace;
      ...
      fwire3_v.setVisAttributes(desc.visAttributes( Form("dch_vis_cell_%d",(int) ilayer%2 )));
      ...
      fwire5_v.setVisAttributes(desc.visAttributes( Form("dch_vis_cell_%d", (int) ilayer%2 )));
	...
	- safety_z_interspace;
      ...
      fwire4_v.setVisAttributes(desc.visAttributes( Form("dch_vis_cell_%d",(int) ilayer%2 )));
